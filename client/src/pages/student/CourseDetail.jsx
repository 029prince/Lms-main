...
const CourseDetail = () => {
  ...
  return (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-baseline md:px-36 px-8 md:pt-30 pt-20 text-left">
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                            ...
                            <div className="flex gap-2">
                              {lecture.isPreviewFree && (
                                <p onClick={() => setPlayerData({ videoId: getYouTubeVideoId(lecture.lectureUrl) })}
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              <img className="w-3.5" src={assets.time_clock_icon} alt="time_left" />
