...
const Testimonial = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500'>Hear from our learner as they share their journeys of transformation,
          ...
          border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
            <div className='flex items-center gap-4 px-5 py-4 bg-gray-500/10'>
              ...
              <div>
                ...
                <p className='text-green-800/80'>{testimonial.role}</p>
              </div>
            </div>
